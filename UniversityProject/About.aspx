<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="UniversityProject.About" %>
  ...
  <main id="main">
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/ebay1.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>eBay integrates MIDDLE MAN enabling the buying and selling of vehicles online</h3>
            <p class="font-italic">
             MIDDLE MAN is integrated into both the eBay Motors website and mobile app, and is first digital payment option since the launch of the new eBay Motors app in December 2019
            </p>
            <ul>
              <li><i class="icofont-check-circled"></i> MIDDLE MAN handles the buying and selling large.</li>
              <li><i class="icofont-check-circled"></i> From computer hardware to luxury goods.</li>
              <li><i class="icofont-check-circled"></i> Buying and selling expensive jewelry online can be difficult.</li>
            </ul>
            <p>
              When buying classic cars, a used sailboat or even an aircraft engine MIDDLE MAN ensures money transfer and vehicle delivery with every sale. Our experienced personnel can even help you with shipping documentation, titles, liens and more.
            </p>
          </div>
        </div>
    ...
    <section class="testimonials" data-aos="fade-up">
      <div class="container">
        ...
        <div class="owl-carousel testimonials-carousel">
          ...
          <div class="testimonial-item">
            <img src="assets/img/testimonials/waleed.jpg" class="testimonial-img" alt="">
            <h3>Waleed Irshad</h3>
            <h4>Designer</h4>
            <p>
              <i class="bx bxs-quote-alt-left quote-icon-left"></i>
